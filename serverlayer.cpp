...
bool serverlayer::init()
{
	...
	auto *menuItem = MenuItemImage::create("server1.png", "server2.png", CC_CALLBACK_1(serverlayer::menucallback, this));
	//color
	menuItem->setTag(101);
	menuItem->setPosition(Vec2(winSize.width *0.8, winSize.height*0.2));

	auto *menuItem_2 = MenuItemImage::create("client1.png", "client2.png", CC_CALLBACK_1(serverlayer::menucallback, this));
